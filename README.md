...
```bash
python sortphotos.py -c -r --sort %Y-%m-%b --rename ofp-%Y-%m-%d-%H%M -t /Users/aeo/Downloads /Users/aeo/Pictures/ouellet-family-pictures

### The big one

python sortphotos.py -c -r --sort %Y-%m-%b --rename ofp-%Y-%m-%d-%H%M -t /Users/aeo/Pictures/OuelletFamilyPictures-octave /Users/aeo/Pictures/ouellet-family-pictures
